...
Figure 図 5-5. origin/master をマージした後の John のリポジトリ
...
Figure 図 5-6. origin サーバーにプッシュした後の John の履歴
...
Figure 図 5-8. John の変更を取り込んだ後の Jessica の履歴
...
Figure 図 5-9. John の変更をマージした後の Jessica の履歴
...
Figure 図 5-10. すべての変更をサーバーに書き戻した後の Jessica の履歴
...
Figure 図 5-11. 複数開発者での Git を使ったシンプルな開発作業のイベントシーケンス
...
Figure 図 5-13. Jessica がブランチにコミットした後のコミット履歴
...
Figure 図 5-14. Jessica が両方のトピックブランチをマージしたあとのコミット履歴
...
Figure 図 5-15. 管理されたチームでのワークフローの基本的な流れ
...
Figure 図 5-16. featureB に関する作業のコミット履歴
...
Figure 図 5-17. featureA の作業を終えた後のコミット履歴
...
Figure 図 5-18. featureBv2 の作業を終えた後のコミット履歴
...
Figure 図 5-19. いくつかのトピックブランチを含む履歴

Insert 18333fig0520.png
Figure 図 5-20. トピックブランチをマージした後の状態
...
Figure 図 5-21. トピックブランチのマージ前

Insert 18333fig0522.png 
Figure 図 5-22. トピックブランチのマージ後

Insert 18333fig0523.png 
Figure 図 5-23. トピックブランチのリリース後
...
Figure 図 5-24. 複数のトピックブランチの並行管理
...
Figure 図 5-25. 常時稼働する統合用ブランチへのトピックブランチのマージ
...
Figure 図 5-27. トピックブランチのコミットをチェリーピックした後の歴史
