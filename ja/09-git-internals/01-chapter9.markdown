...
Figure 図9-3. Gitレポジトリ内のすべてのオブジェクト
...
Figure 図9-4. ブランチのヘッドへの参照を含むGitディレクトリオブジェクト
