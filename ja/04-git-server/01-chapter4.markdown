...
Figure 図 4-1. GitWeb のユーザーインターフェイス
...
Figure 図 4-4. GitHub のユーザーダッシュボード
...
Figure 図 4-5. GitHub での新しいリポジトリの作成
...
Figure 図 4-6. GitHub でのプロジェクトのヘッダ情報
...
Figure 図 4-8. 公開 URL とプライベート URL が表示されたヘッダ
...
Figure 図 4-9. Subversion からのインポート
...
Figure 図 4-13. GitHub プロジェクトのメインページ
